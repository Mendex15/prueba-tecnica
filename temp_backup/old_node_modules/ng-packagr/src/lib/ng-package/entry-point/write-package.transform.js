...
const writePackageTransform = (options) => (0, transform_1.transformFromPromise)(async (graph) => {
    ...
    const entryPoint = entryPoints.find(select_1.isInProgress);
    ...
    if (!ngEntryPoint.isSecondaryEntryPoint) {
        ...
        await (0, fs_1.mkdir)(ngEntryPoint.destinationPath, { recursive: true });
...
async function copyAssets(graph, entryPointNode, ngPackageNode, entryPoints) {
    const ngPackage = ngPackageNode.data;
 ...
 */
function generatePackageExports({ destinationPath, packageJson }, entryPoints) {
